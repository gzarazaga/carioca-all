...
describe('FormationBuilder', () => {
  ...
  it('tipo Pierna está seleccionado por defecto', () => {
    ...
    expect(piernaBtn.className).toContain('from-primary-600')
    const escaleraBtn = screen.getByText('Escalera')
    expect(escaleraBtn.className).not.toContain('from-primary-600')
  })
  ...
  it('cambia el tipo al hacer click en Escalera', () => {
    ...
    const escaleraBtn = screen.getByText('Escalera')
    expect(escaleraBtn.className).toContain('from-primary-600')
  })
